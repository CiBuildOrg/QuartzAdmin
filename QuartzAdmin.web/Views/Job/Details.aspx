...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <p>
            FullName:
            <%= Html.Encode(Model.JobDetail.JobType.FullName)%>
        </p>
        <p>
            Description:
        ...
        <p>
            Persist JobData After Execution:
            <%= Html.Encode(Model.JobDetail.PersistJobDataAfterExecution)%>
        </p>
        <p>
            Durable:
        ...
        <p>
            ...
            <%= Html.Encode(Model.JobDetail.ConcurrentExecutionDisallowed)%>
        </p>
        <p>
            Job Data Map
            <ul>
            <%foreach (KeyValuePair<string, object> d in Model.JobDetail.JobDataMap)
              {%>
    ...
    <fieldset>
        ...
        <ul>
        <%foreach (Quartz.ITrigger trigger in Model.Triggers)
          {%>
          <li><%=Html.ActionLink(trigger.GetType().FullName, "Details", "Trigger", new {instanceName=ViewData["instanceName"], groupName=trigger.Key.Group, itemName=trigger.Key.Name}, null) %></li>
        <%} %>
        </ul>
    </fieldset>
    <p>
