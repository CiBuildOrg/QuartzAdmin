        ...
        YAHOO.util.Event.addListener(window, "load", function() {
            EnhanceFromMarkup = new function() {
				var myColumnDefs = [
					...
					{ key: "PersistJobDataAfterExecution", label: "PersistJobDataAfterExecution", sortable: true },
					{ key: "Durable", label: "Durable", sortable: true },
					{ key: "ConcurrentExecutionDisallowed", label: "ConcurrentExecutionDisallowed", sortable: true }
				];
                ...
                this.myDataSource.responseSchema = {
                    fields: [
                        ...
                        { key: "PersistJobDataAfterExecution", label: "PersistJobDataAfterExecution" },
                        { key: "Durable", label: "Durable" },
                        { key: "ConcurrentExecutionDisallowed", label: "ConcurrentExecutionDisallowed" }
                    ]
                };
